...
class PostresAdapter(var lista: ArrayList<Producto>, val context: Context):
    RecyclerView.Adapter<PostresAdapter.MyHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyHolder {
        val vista: View = LayoutInflater.from(context).inflate(R.layout.recycler_postres, parent, false)
